...
namespace Luban.Job.Cfg.Utils
{
    static class DataUtil
    {
        ...
        public static DType CreateVector(TVector2 type, string x)
        {
            ...
            if (values.Length != 2)
            {
                throw new Exception($"'{x}' ���ǺϷ�vector2��������");
            }
        ...
        public static DType CreateVector(TVector3 type, string x)
        {
            ...
            if (values.Length != 3)
            {
                throw new Exception($"'{x}' ���ǺϷ�vector3��������");
            }
        ...
        public static DType CreateVector(TVector4 type, string x)
        {
            ...
            if (values.Length != 4)
            {
                throw new Exception($"'{x}' ���ǺϷ�vector4��������");
            }
        ...
        public static DefBean GetImplTypeByNameOrAlias(DefBean bean, string subType)
        {
            ...
            {
                throw new Exception($"module:'{bean.Namespace}' ��̬����type����Ϊ��");
            }
            ...
            if (defType == null)
            {
                throw new Exception($"module:'{bean.Namespace}' type:'{subType}' ���ǺϷ�����");
            }
            if (defType.IsAbstractType)
            {
                throw new Exception($"module:'{bean.Namespace}' type:'{subType}' �ǳ�����. ���ܴ���ʵ��");
            }
            return defType;
        }
